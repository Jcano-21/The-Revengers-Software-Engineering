...
def request_modal_update(data_inventory, data_resupply, data_averages):
    ...
    # Train the model
    history = model.fit(X_train, y_train, epochs=500, batch_size=100, validation_data=(X_test, y_test), callbacks=[early_stopping], verbose=1)
...
def request_modal_update_RSWater(data_inventory, data_resupply, data_averages):
    ...
    # Train the model
    history = model.fit(X_train, y_train, epochs=50, batch_size=30, validation_data=(X_test, y_test), callbacks=[early_stopping], verbose=1)
    ...
    resupply_amounts = {'remaining_potableL': data_averages['USAGE_AVERAGE_POT'],'technicalL': data_averages['USAGE_AVERAGE_TECH'],'rodnik_potableL': data_averages['USAGE_AVERAGE_ROD'] }
    rate_averages = {'remaining_potableL': data_averages['RATE_AVERAGE_POT'],'technicalL': data_averages['RATE_AVERAGE_TECH'],'rodnik_potableL': 0 }
    rate_diff_averages = {'remaining_potableL': data_averages['RATE_DIFF_AVERAGE_POT'],'technicalL': data_averages['RATE_DIFF_AVERAGE_TECH'],'rodnik_potableL': 0}
    ...
    # Create a DataFrame for the predicted values
    predicted_df_LSTM = pd.DataFrame(predicted_values, columns=data.columns, index=future_dates_predict)
...
def request_modal_update_USWater(data_inventory, data_resupply, data_averages):
    ...
    resupply_amounts = {'corrected_potableL': data_averages['USAGE_AVERAGE_POT'],'corrected_technicalL': data_averages['USAGE_AVERAGE_TECH']}
    rate_averages = {'corrected_potableL': data_averages['RATE_AVERAGE_POT'],'corrected_technicalL': data_averages['RATE_AVERAGE_TECH']}
    rate_diff_averages = {'corrected_potableL': data_averages['RATE_DIFF_AVERAGE_POT'],'corrected_technicalL': data_averages['RATE_DIFF_AVERAGE_TECH']}
...
def request_modal_update_Gas(data_inventory, data_resupply, data_averages):
    ...
    # Train the model
    history = model.fit(X_train, y_train, epochs=50, batch_size=8, validation_data=(X_test, y_test), callbacks=[early_stopping], verbose=1)
    ...
    resupply_amounts = {'newO2kg': data_averages['USAGE_AVERAGE_O2'],'newN2kg': data_averages['USAGE_AVERAGE_N2']}
    rate_averages = {'newO2kg': data_averages['RATE_AVERAGE_O2'],'newN2kg': data_averages['RATE_AVERAGE_N2']}
    rate_diff_averages = {'newO2kg': data_averages['RATE_DIFF_AVERAGE_O2'],'newN2kg': data_averages['RATE_DIFF_AVERAGE_N2']}
